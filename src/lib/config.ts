export const siteConfig = {
  ...
  url:
    ...
    (process.env.VERCEL === '1' ? 'https://dubailuxurycarrentals.ae' : 'http://127.0.0.1:43117'),
  whatsappNumber: process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '971545974005',
  description:
    'Explore luxury car rental options in Dubai by brand, category and daily rate. View photos and send Zavi a reservation request for your dates.',
